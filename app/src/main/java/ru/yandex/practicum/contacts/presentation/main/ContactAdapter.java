...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> {
    ...
    /*
    андроид студия сообщала мне, что он не используется, и его по идее можно удалить,
    но не стал его трогать, так как мы вроде пока не особо трогаем остальную часть приложений.
    Неиспользуемые импорты @Nonnull удалил
    */
